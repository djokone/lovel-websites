<template>
  ...
  >
    ...
    <el-table-column  v-for="(field, index) in formatedFields" v-if="!hasParent(field)&&!isSlot(field)" :label="getText(field.name)" :prop="field.name">
    </el-table-column>
...
<script>
  ...
  import { Ucfirst } from 'src/libs/textUtils'
