export default class DatabaseManager {
  ...
  static initDatabase ({
    ...
    if (type === 'nativescript') {
      ...
      console.log('current DatabaseId ' + this.currentDatabaseId)
      console.log()
      if (!this.firebase.apps.find((v) => v.options.projectId === namespace)) {
        // if (this.fire) {
        //
        // }
    ...
    console.log('Database ' + namespace + ' is initialize')
